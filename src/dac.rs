...
pub struct DelegatableAnonCredScheme {
    ...
    pub pk0: PublicKeyG1,
    pub sk0: SecretKey,
    pub nym0: (PublicKeyG1, Option<SecretKey>),
}
...
impl DelegatableAnonCredScheme {
    ...
    pub fn KeyGen(&self) -> (KeyPairG1, KeyPairG2) {
        ...
        return (KeyPairG1(sk_even, pk_even), KeyPairG2(sk_odd, pk_odd));
    }
    ...
    pub fn NymGen(&self, even: KeyPairG1, odd: KeyPairG2) -> (KeyPairG1, KeyPairG2) {
        ...
        return (KeyPairG1(sk_even, nym_even), KeyPairG2(sk_odd, nym_odd));
    }
...
pub struct SecretKey(pub Vec<BIG>);
type PublicKeyG2 = Vec<ECP2>;
type PublicKeyG1 = Vec<ECP>;

pub struct KeyPairG1(pub(crate) SecretKey, pub(crate) PublicKeyG1);
pub struct KeyPairG2(pub(crate) SecretKey, pub(crate) PublicKeyG2);
...
mod test {
    ...
    fn test_dac() {
        ...
        let (_, KeyPairG2(sk_odd1, nym_odd1)) = dac.NymGen(even_keys1, odd_keys1);
        ...
        let (KeyPairG1(sk_even2, nym_even2), _) = dac.NymGen(even_keys2, odd_keys2);
        ...
        let (_, KeyPairG2(sk_odd3, nym_odd3)) = dac.NymGen(even_keys3, odd_keys3);
